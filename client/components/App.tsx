...
function App() {
  ...
  function iterateMonths() {
    //alert(months)
    if (data) {
      const totalToPay = data.reduce((acc, debt) => acc + debt.debt_owing, 0)
      ...
      if (totalToPay > 0) {
        ...
        for (let i = 0; i < data.length; i++) {
          ...
          if (debt.debt_owing > 0) {
            ...
            //console.log('minimum: ', debt.minimum_payment)
            debt.debt_owing -= debt.minimum_payment
          }
          if (debt.debt_owing <= 0) {
        ...
        <div className="app">
          ...
          <nav>
            ...
            <div className="debt-info-container">
              ...
              <p>Debt will be paid in {months}</p>
            </div>
